...
if platform.system() == "Windows":
    DATA_DIR = os.path.join(os.environ.get("APPDATA", "."), "AgentIA")
elif platform.system() == "Darwin":
    DATA_DIR = os.path.expanduser("~/Library/Application Support/AgentIA")
else:
    DATA_DIR = os.path.expanduser("~/.local/share/AgentIA")
...
def get_system_prompt() -> str:
    ...
    return f"""Tu es un assistant IA local qui aide l'utilisateur dans son quotidien.
